...
import Flexify from '../../assets/Flexify_Profile.png'
    ...
    <>
      <div className='grid gap-y-16 mt-12'>
        <div className='each-project flex gap-14' data-aos="fade-up">
          ...
          <div className='project-details'>
            <div className='pl-[6.7rem] pr-[6.7rem] pt-[3rem] pb-[3rem] border-dashed border-2 border-sky-500 rounded-xl'>
              <Link
                to='Home/projects/Flexify_Store'
              >
                <img
                  style={{
                  borderRadius: '12px'
          ...
          <div className='project-details'>
            <div className='border-dashed border-2 border-sky-500 rounded-xl'>
              <Link to='Home/projects/Personal_Portfolio'>
                <img
                  style={{
                  borderRadius: '12px'
                }}
            ...
            <ol className='ml-6' style={{ listStyleType: 'disc' }}>
              <li className='text-[1.1rem] mt-2'>Personal_Portfolio</li>
            </ol>
          </div>
        </div>
